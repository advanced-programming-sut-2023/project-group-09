...
public class ChangeUsername extends Application {
    ...
    public void makeScene() throws IOException {
        BorderPane pane = FXMLLoader.load(
                new URL(Objects.requireNonNull(LoginMenu.class.getResource("/FXML/profile/changeUsername.fxml")).toExternalForm()));
    ...
    public void setEvents(){
        username.textProperty().addListener((observableValue, o, n) -> {
            String massage = UserController.validateUsername(n);
