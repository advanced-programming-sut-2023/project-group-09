...
public class GameWeapons extends GameGoods {
    protected static void createMace() {
        Goods weapon = new Goods("mace", "weapon","armourer", 290);
    ...
    protected static void createSwords() {
        Goods weapon = new Goods("sword", "weapon","armourer", 290);
        weapon.addRequired("iron", 1);
    ...
    protected static void createBow() {
        Goods weapon = new Goods("bow", "weapon","armourer",155);
    ...
    protected static void createSpear() {
        Goods weapon = new Goods("spear", "weapon","armourer", 100);
    ...
    protected static void createPike() {
        Goods weapon = new Goods("pike", "weapon","armourer", 180);
        weapon.addRequired("wood", 2);
    ...
    protected static void createLeatherArmour() {
        Goods weapon = new Goods("leatherArmour", "weapon","armourer", 125);
    ...
    protected static void createMetalArmour() {
        Goods weapon = new Goods("metalArmour", "weapon","armourer", 290);
        weapon.addRequired("iron", 1);
    ...
    protected static void createCrossbow() {
        Goods weapon = new Goods("crossbow", "weapon","armourer", 290);
