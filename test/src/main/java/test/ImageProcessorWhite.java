...
public class ImageProcessorWhite {
    ...
    public static void makeRed(int i) {
        ...
        String inputImagePath = "files/test/white/0_0img" + i + ".png";
        ...
        try {
            ...
            for (int y = 0; y < image.getHeight(); y++) {
                for (int x = 0; x < image.getWidth(); x++) {
                    ...
                    int blue = pixelColor.getBlue();
                    if (red > 100 && blue > 100 && green > 100) {
                        Color newColor = new Color(0, Math.min(225, green + 200), Math.min(225, blue));
                        image.setRGB(x, y, newColor.getRGB());
                    }
        ...
        try {
            ...
            for (int y = 0; y < image.getHeight(); y++) {
                for (int x = 0; x < image.getWidth(); x++) {
                    ...
                    int blue = pixelColor.getBlue();
                    if (red > 100 && blue > 100 && green > 100) {
                        Color newColor = new Color(red, green/2, 0);
                        image.setRGB(x, y, newColor.getRGB());
                    }
                }
            }
        ...
        try {
            ...
            for (int y = 0; y < image.getHeight(); y++) {
                for (int x = 0; x < image.getWidth(); x++) {
                    ...
                    int blue = pixelColor.getBlue();
                    if (red > 100 && blue > 100 && green > 100) {
                        Color newColor = new Color(red, blue, 0);
                        image.setRGB(x, y, newColor.getRGB());
                    }
    ...
    public static void makeBlue(int i) {

        String inputImagePath = "files/test/white/0_0img" + i + ".png";
        String outputImagePath = "files/test/blue/0_0img" + i + ".png";
