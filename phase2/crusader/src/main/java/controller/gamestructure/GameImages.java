...
public class GameImages {
    ...
    public static void addSickness() {
        for (int i = 1; i <= 32; i++) {
            Image image = new Image(GameViewController.class.getResource(Paths.MAP_IMAGES.getPath())
                    .toExternalForm() + "sickness/Image" + i + ".png");
            imageViews.put("sickness_" + i,image);
        }
    }
